...
A basic understanding of Client concepts is required. Details can be found in the link:/docs/CLIENT/client-documentation-bundle/index.html[Client Documentation,window=_blank].
