...
The current UI representation of the Form Engine is mainly controlled by field values – either directly by the values shown in inputs or indirectly by "dependencies" (see link:/docs/SME/sme-fm-ba-docs/index.html[Form Model Editor documentation,window=_blank] for details about dependencies).
