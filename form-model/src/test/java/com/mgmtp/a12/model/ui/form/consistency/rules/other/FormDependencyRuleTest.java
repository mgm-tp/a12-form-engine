...
public class FormDependencyRuleTest {
	...
	public void setUp() throws Exception {
		formDependencyRule.setModelResolver(new FileBasedPicusModelResolver(
			"com/mgmtp/a12/model/ui/form/consistency/rules/cycleDetection/"));
	}
	...
	public void checkNoCycle() throws Exception {
		final MeliesModel formModel = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/cycleDetection/no-cycle-form.json");
		final List<Problem> problems = formDependencyRule.executeRule(formModel);
	...
	public void checkFieldDependencyCycle() throws Exception {
		final MeliesModel formModel = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/cycleDetection/field-dependency-cycle-form.json");
		final List<Problem> problems = formDependencyRule.executeRule(formModel);
	...
	public void checkEnumDependencyCycle() throws Exception {
		final MeliesModel formModel = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/cycleDetection/enum-dependency-cycle-form.json");
		final List<Problem> problems = formDependencyRule.executeRule(formModel);
	...
	public void checkComputationCycle() throws Exception {
		final MeliesModel formModel = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/cycleDetection/computation-cycle-form.json");
		final List<Problem> problems = formDependencyRule.executeRule(formModel);
	...
	public void checkMixedDependencyCycle() throws Exception {
		final MeliesModel formModel = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/cycleDetection/mixed-dependency-cycle-form.json");
		final List<Problem> problems = formDependencyRule.executeRule(formModel);
	...
	public void checkMixedCycle() throws Exception {
		final MeliesModel formModel = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/cycleDetection/mixed-cycle-form.json");
		final List<Problem> problems = formDependencyRule.executeRule(formModel);
