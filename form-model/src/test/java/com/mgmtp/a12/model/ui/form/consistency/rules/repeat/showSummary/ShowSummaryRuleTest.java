...
public class ShowSummaryRuleTest {
	...
	public void setUp() {
		rule.setModelResolver(new FileBasedPicusModelResolver(
			"com/mgmtp/a12/model/ui/form/consistency/rules/repeat/showSummary/"));
		model = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/repeat/showSummary/ShowSummary-form.json");
