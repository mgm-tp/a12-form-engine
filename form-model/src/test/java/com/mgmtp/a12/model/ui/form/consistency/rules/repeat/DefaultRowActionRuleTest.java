...
public class DefaultRowActionRuleTest {
	...
	public void setUp() {
		...
		final MeliesModel productForm =
			ModelLoader.loadModel("com/mgmtp/a12/model/ui/form/consistency/rules/repeat/rowaction/TestForm.json");
		problems = defaultRowActionRule.executeRule(productForm);
	}
