 ...
 */
package com.mgmtp.a12.model.ui.form.consistency.rules.label;
...
public class LabelConsistencyRuleTest {
	...
	public void setUp() {
		...
		labelConsistencyRule.setModelResolver(
			new FileBasedPicusModelResolver(
				"com/mgmtp/a12/model/ui/form/consistency/rules/label/"));
	}

	@Test
	public void checkValidLabels() throws Exception {
		final MeliesModel testForm = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/label/LabelTestForm.json");
		final List<Problem> problems = labelConsistencyRule.executeRule(testForm);
	...
	public void checkInvalidNoTypeSet() throws Exception {
		final MeliesModel testForm = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/label/InvalidMissingTypeTestForm.json");
	...
	public void checkInvalidNoTextSet() throws Exception {
		final MeliesModel testForm = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/label/InvalidMissingTextTestForm.json");
	...
	public void checkInvalidBothTextsSet() throws Exception {
		final MeliesModel testForm = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/label/InvalidBothTextsSetTestForm.json");
	...
	public void checkInvalidWrongTypeSet() throws Exception {
		final MeliesModel testForm = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/label/InvalidWrongLabelTypeTestForm.json");
	...
	public void checkInvalidExpressionLabels() throws Exception {
		final MeliesModel testForm = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/label/InvalidExpressionLabelsTestForm.json");
	...
	public void checkInvalidContextWithoutFieldReferences() throws Exception {
		final MeliesModel testForm = ModelLoader.loadModel(
			"com/mgmtp/a12/model/ui/form/consistency/rules/label/InvalidContextWithoutFieldReferenceTestForm.json");
