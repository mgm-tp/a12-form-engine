 ...
 */
package com.mgmtp.a12.formengine.consistency.rules.repeat.showCommaSeparated;

import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_REPEAT_SHOW_COMMA_SEPARATED_NO_MULTI_SELECT_COLUMN;
import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_REPEAT_SHOW_COMMA_SEPARATED_ROW_HEIGHT_GIVEN;
import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_REPEAT_SHOW_COMMA_SEPARATED_UNNECESSARY;
...
public class ShowCommaSeparatedRuleTest {
	...
	public void setUp() {
		model = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/repeat/showCommaSeparated/ShowCommaSeparated-form.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver("com/mgmtp/a12/formengine/consistency/rules/repeat/showCommaSeparated/");
		problems = rule.execute(model, RuleTestHelper.createDocumentModelAccess(modelResolver, model));
