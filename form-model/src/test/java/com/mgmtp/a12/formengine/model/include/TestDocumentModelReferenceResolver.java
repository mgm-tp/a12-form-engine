...
public class TestDocumentModelReferenceResolver implements IDocumentModelReferenceResolver, IUnexpandedModelResolver {

	private final String basePath;

	public TestDocumentModelReferenceResolver(final String basePath) {
		this.basePath = basePath;
	}

	@Override
	public IDocumentModel getDocumentModel(final String reference) {
		return new TestDocumentModelResolver(basePath).resolveDM(reference);
	}

	@Override
	public @NonNull DMLike resolve(@NonNull String dmId) {
		return new DMWrapper(getDocumentModel(dmId));
	}
}
