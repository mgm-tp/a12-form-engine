...
public class MultiFileUploadRuleTest {
	...
	private static final String TEST_PACKAGE = "com/mgmtp/a12/formengine/consistency/rules/repeat/multiFileUpload/";
	...
	public void testRule() {
		...
		final List<Problem> problems = multiFileUploadRule.execute(productForm, RuleTestHelper.createDocumentModelAccess(modelResolver, productForm));
