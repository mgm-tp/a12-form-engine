...
public class FormCheckStyleRuleTest {
	...
	public void checkStyles() throws Exception {
		final FormModel productForm =
			ModelLoader.loadModel("com/mgmtp/a12/formengine/consistency/rules/metadata/Company.json");
		final List<Problem> problems = formCheckStylesRule.execute(productForm, null);
	...
	public void checkWrongStyles() throws Exception {
		final FormModel productForm = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/metadata/CompanyWithWrongStyle.json");
		final List<Problem> problems = formCheckStylesRule.execute(productForm, null);
