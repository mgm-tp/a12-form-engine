 ...
 */
package com.mgmtp.a12.formengine.consistency.rules.infinitescrolling;

import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_ACTION_COLUMN_WIDTH_TOO_MANY_DECIMAL_PLACES;
import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_ACTION_COLUMN_WIDTH_TOO_SMALL;
import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_REPEAT_VIRTUAL_SCROLLING_CONFIG;
import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_REPEAT_VIRTUAL_SCROLLING_NO_ROW_HEIGHT;
import static com.mgmtp.a12.formengine.consistency.FormModelCategory.FORM_MODEL_REPEAT_VIRTUAL_SCROLLING_PAGING;
...
public class InfiniteScrollingRuleTest {
	...
	public void setUp() {
		model = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/infinitescrolling/TestForm.json");
		final InfiniteScrollingRule virtualScrollingRule = new InfiniteScrollingRule();
		problems = virtualScrollingRule.execute(model, null);
