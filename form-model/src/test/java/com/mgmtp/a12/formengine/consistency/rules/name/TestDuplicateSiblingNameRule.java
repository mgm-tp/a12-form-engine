...
public class TestDuplicateSiblingNameRule {
	...
	public void verifyDuplicates() throws Exception {
		...
		final FormModel productForm =
			ModelLoader.loadModel("com/mgmtp/a12/formengine/consistency/rules/name/DuplicateNamesModel.json");
		final List<Problem> problems = duplicateSiblingNameRule.execute(productForm, null);
	...
	public void verifyNoDuplicates() throws Exception {
		final FormModel productForm =
			ModelLoader.loadModel("com/mgmtp/a12/formengine/consistency/rules/name/NoDuplicateNamesModel.json");

		Assert.assertTrue(duplicateSiblingNameRule.execute(productForm, null).isEmpty());
	}
}
