...
public class SecretAreaLineBreaksRuleTest {
	...
	public void verifySecretInvalidArea() throws Exception {
		...
		final FormModel productForm =
			ModelLoader
				.loadModel("com/mgmtp/a12/formengine/consistency/rules/other/FormModelSecretInvalidArea.json");
		...
		final List<Problem> problems = secretAreaLineBreaksRule.execute(productForm, RuleTestHelper.createDocumentModelAccess(modelResolver, productForm));
	...
	public void verifySecretInvalidLineBreaks() throws Exception {
		...
		final FormModel productForm = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/other/FormModelSecretInvalidLineBreaks.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver("com/mgmtp/a12/formengine/consistency/rules/other/");
		final List<Problem> problems = secretAreaLineBreaksRule.execute(productForm, RuleTestHelper.createDocumentModelAccess(modelResolver, productForm));
	...
	public void verifySecretValid() throws Exception {
		...
		final FormModel productForm =
			ModelLoader.loadModel("com/mgmtp/a12/formengine/consistency/rules/other/FormModelSecretValid.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver("com/mgmtp/a12/formengine/consistency/rules/other/");
		Assert.assertTrue(secretAreaLineBreaksRule.execute(productForm, RuleTestHelper.createDocumentModelAccess(modelResolver, productForm)).isEmpty());
	}
}
