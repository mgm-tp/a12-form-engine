...
import com.mgmtp.a12.formengine.model.types.ObjectFactory;
	...
	private static class ModelElements {
		...
		public static ModelElements load() {
			final FormModel model =
				new FormModelJsonStreamSerializer().deserialize(AncestorRelationMutationTest.class.getResourceAsStream(
