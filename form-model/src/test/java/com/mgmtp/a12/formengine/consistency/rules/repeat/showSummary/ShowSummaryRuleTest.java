...
public class ShowSummaryRuleTest {

	private FormModel model;
	private List<Problem> problems;
	private final ShowSummaryRule rule = new ShowSummaryRule();

	@BeforeClass
	public void setUp() {
		model = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/repeat/showSummary/ShowSummary-form.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver("com/mgmtp/a12/formengine/consistency/rules/repeat/showSummary/");
