...
public class TestIncludeExpansion {
	...
	public void run(final String testCase) throws IOException, JSONException {
		...
		final var modelResult = modelResolver.resolveFormModel(testCase + "-include.form");
		...
		final var expectedModelString = new String(
			getClass().getResourceAsStream(testCase + "/" + testCase + "-expected.form.json").readAllBytes(),
