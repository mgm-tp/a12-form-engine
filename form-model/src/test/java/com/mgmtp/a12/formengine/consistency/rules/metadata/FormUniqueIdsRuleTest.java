...
import com.mgmtp.a12.formengine.consistency.rules.consistency.FormUniqueIdsRule;
...
public class FormUniqueIdsRuleTest {
	...
	public void checkValidIds() throws Exception {
		final FormModel testForm = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/metadata/IdTestForm.json");
		final List<Problem> problems = consistencyRule.execute(testForm, null);
	...
	public void checkInvalidIds() throws Exception {
		final FormModel testForm = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/metadata/InvalidIdTestForm.json");
