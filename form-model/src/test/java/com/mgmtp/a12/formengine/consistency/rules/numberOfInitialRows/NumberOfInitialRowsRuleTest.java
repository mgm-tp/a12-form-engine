 ...
 */
package com.mgmtp.a12.formengine.consistency.rules.numberOfInitialRows;
...
public class NumberOfInitialRowsRuleTest {
	...
	public void setUp() {
		model = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/numberOfInitialRows/TestForm.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver("com/mgmtp/a12/formengine/consistency/rules/numberOfInitialRows/");
		problems = numberOfInitialRowsRule.execute(model, RuleTestHelper.createDocumentModelAccess(modelResolver, model));
