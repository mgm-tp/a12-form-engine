...
public class FormDependentControlRuleTest {
	...
	public void checkMissingReferences() throws Exception {
		...
		final FormModel productForm = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/other/DependentControlWithMissingScreenElement.json");
		...
		final List<Problem> problems = formDependentControlRule.execute(productForm, RuleTestHelper.createDocumentModelAccess(modelResolver, productForm));
	...
	public void checkInvalidParentReferences() throws Exception {
		...
		final FormModel productForm = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/other/ProductFormWithDependentControl.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver(
			"com/mgmtp/a12/formengine/consistency/rules/other/");
		final List<Problem> problems = formDependentControlRule.execute(productForm, RuleTestHelper.createDocumentModelAccess(modelResolver, productForm));
	...
	public void checkAtLeastOneScreenElementGiven() throws Exception {
		...
		final FormModel form = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/other/DependentControlWithNoScreenElement.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver(
			"com/mgmtp/a12/formengine/consistency/rules/other/");
		final List<Problem> problems = formDependentControlRule.execute(form, RuleTestHelper.createDocumentModelAccess(modelResolver, form));
	...
	public void checkReferencesToDifferentScreen() throws Exception {
		...
		final FormModel form = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/other/DependentControlWithReferencesToDifferentScreen.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver(
			"com/mgmtp/a12/formengine/consistency/rules/other/");
		final List<Problem> problems = formDependentControlRule.execute(form, RuleTestHelper.createDocumentModelAccess(modelResolver, form));
	...
	public void checkIndexedControlReferences() throws Exception {
		...
		final FormModel form = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/other/DependentControlWithIndexedReferencesToDifferentScreen.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver(
			"com/mgmtp/a12/formengine/consistency/rules/other/");
		final List<Problem> problems = formDependentControlRule.execute(form, RuleTestHelper.createDocumentModelAccess(modelResolver, form));
	...
	public void checkIncompatibleDataContexts() throws Exception {
		...
		final FormModel form = ModelLoader.loadModel(
                "com/mgmtp/a12/formengine/consistency/rules/other/DependentControlWithIncompatibleDataContext.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver(
			"com/mgmtp/a12/formengine/consistency/rules/other/");
		final List<Problem> problems = formDependentControlRule.execute(form, RuleTestHelper.createDocumentModelAccess(modelResolver, form));
