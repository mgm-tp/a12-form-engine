...
public class FieldColumnTest {
	...
	public void setUp() {
		...
		final FormModel productForm =
			ModelLoader.loadModel("com/mgmtp/a12/formengine/consistency/rules/repeat/fieldcolumn/FormModel.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver("com/mgmtp/a12/formengine/consistency/rules/repeat/fieldcolumn/");
		problems = fieldColumnReferenceRule.execute(productForm, RuleTestHelper.createDocumentModelAccess(modelResolver, productForm));
