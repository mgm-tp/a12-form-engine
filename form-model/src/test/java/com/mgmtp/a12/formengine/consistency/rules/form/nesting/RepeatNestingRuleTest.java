 ...
 */
package com.mgmtp.a12.formengine.consistency.rules.form.nesting;
...
public class RepeatNestingRuleTest {
	...
	@BeforeClass
	public void execute() {
		final FormModel testModel =
			ModelLoader.loadModel("com/mgmtp/a12/formengine/consistency/rules/form/nesting/FormModel.json");
		final FileBasedDocumentModelResolver modelResolver = new FileBasedDocumentModelResolver("com/mgmtp/a12/formengine/consistency/rules/form/nesting/");
		problems = repeatNestingRule.execute(testModel, RuleTestHelper.createDocumentModelAccess(modelResolver, testModel));
