...
import static com.mgmtp.a12.formengine.consistency.rules.name.DuplicateNamesDetectionVisitor.MAJOR_BUTTONS;

import com.mgmtp.a12.formengine.consistency.rules.name.DuplicateNamesDetectionVisitor;
...
public class DuplicateSiblingNameFix implements ProblemFix {
	...
	@Override
	public void fix(final FormModel model) {
	...
	private void fixScreenNames(final FormModel model) {
