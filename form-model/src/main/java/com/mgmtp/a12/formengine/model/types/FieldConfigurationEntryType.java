...
public class FieldConfigurationEntryType implements Serializable, Annotated {
	...
	protected LabelPlacementEnumType labelPlacement;
	...
	public void setIcon(final IconType value) {
		this.icon = value;
	}
	...
	public FieldConfigurationEntryType withIcon(final IconType value) {
		setIcon(value);
		return this;
	}

	public LabelPlacementEnumType getLabelPlacement() {
		return labelPlacement;
	}

	public void setLabelPlacement(final LabelPlacementEnumType value) {
	...
	public FieldConfigurationEntryType withLabelPlacement(final LabelPlacementEnumType value) {
