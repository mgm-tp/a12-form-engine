...
public class IconType implements Serializable {
	...
	private static final long serialVersionUID = 5300477677390609616L;
	...
	public IconType withName(final String value) {
		setName(value);
		return this;
	}

	public IconType withTheme(final String value) {
		setTheme(value);
		return this;
	}
}
