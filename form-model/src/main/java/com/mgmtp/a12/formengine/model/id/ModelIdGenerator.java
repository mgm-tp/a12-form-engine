 ...
 */
package com.mgmtp.a12.formengine.model.id;

import com.mgmtp.a12.formengine.common.IdGenerator;
import com.mgmtp.a12.formengine.model.FormModel;
import com.mgmtp.a12.formengine.model.visitor.FormModelIdWalker;
...
public class ModelIdGenerator implements IdGenerator {
	...
	public ModelIdGenerator(final FormModel model) {
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.mgmtp.a12.formengine.app.state.id.IdGenerator#generate(java.lang.Class)
	 */
	@Override
	...
	private Set<String> gatherUsedIds(final FormModel model) {
