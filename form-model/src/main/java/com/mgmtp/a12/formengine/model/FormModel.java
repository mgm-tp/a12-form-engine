...
public class FormModel implements Model {
	...
	static String loadModelVersion() {
		try(InputStream input = FormModel.class.getClassLoader().getResourceAsStream("version.properties")) {
	...
	public static final String MODEL_VERSION = FormModel.loadModelVersion();
	...
	public FormModel withHeader(final Header value) {
		setHeader(value);
		return this;
	}

	public FormModel withContent(final FormModelContent value) {
		setContent(value);
		return this;
	}
