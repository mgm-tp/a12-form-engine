 ...
 * </ul>
 */
public class HideConditionRule implements ConsistencyRule {
	...
	public List<Problem> execute(final FormModel model, final DocumentModelAccess documentModelAccess) throws ConsistencyValidationException {
		...
		final HideConditionChecker hideConditionChecker = new HideConditionChecker(model, documentModelAccess);
