...
public class IncludeExpansion {
	...
	private static void addFieldConfigEntry(final FormModel model, final FieldConfigurationEntryType entry) {
		final var existingEntry =
			FormModelUtil.getFieldConfiguration(model.getContent().getFieldConfiguration(), entry.getElementRef());
	...
	private static void addGroupConfigEntry(final FormModel model, final GroupConfigurationEntryType entry) {
		final var existingEntry =
			FormModelUtil.getGroupConfiguration(model.getContent().getGroupConfiguration(), entry.getGroupRef());
