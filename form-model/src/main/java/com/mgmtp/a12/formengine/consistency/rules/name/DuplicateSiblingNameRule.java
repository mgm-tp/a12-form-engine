...
public class DuplicateSiblingNameRule implements ConsistencyRule {
	...
	private void addDuplicateScreenNames(final FormModel model, final List<Problem> problemCollection) {
