...
public enum FormModelCategory implements ConsistencyCategory {
		MISSING_DM_ELEMENT_IN_CONTROL("problem.dm.missingElementInControl"),
		MISSING_DM_ELEMENT_IN_OVERVIEW_COLUMN("problem.dm.missingElementInOverviewColumn"),
		MISSING_DM_GROUP_IN_OVERVIEW_COLUMN("problem.dm.missingGroupInOverviewColumn"),
		MISSING_DM_ELEMENT_IN_FIELD_CONFIGURATION("problem.dm.missingElementInFieldConfiguration"),
		MISSING_DM_GROUP_IN_GROUP_CONFIGURATION("problem.dm.missingGroupInGroupConfiguration"),
		MISSING_DM_FIELD_IN_DEPENDENT_FIELD_MASTER("problem.dm.missingFieldInDependentFieldMaster"),
		MISSING_DM_FIELD_IN_DEPENDENT_GROUP_MASTER("problem.dm.missingFieldInDependentGroupMaster"),
		MISSING_DM_FIELD_IN_DEPENDENT_ENUMERATION("problem.dm.missingFieldInDependentEnum"),
		MISSING_DM_FIELD_IN_DEPENDENT_ENUMERATION_MASTER("problem.dm.missingFieldInDependentEnumMaster"),
		MISSING_DM_FIELD_IN_DEPENDENT_FIELD_CASE("problem.dm.missingFieldInDependentFieldCase"),
		MISSING_DM_FIELD_IN_HIDE_CONDITION_MASTER("problem.dm.missingFieldInHideConditionMaster"),
		DEPENDENT_COMBINATION_ENUM_FIELD("problem.dm.dependent.combinationOfEnumerationAndField"),
		DEPENDENT_ENUM_DEPENDENT_FIELD_INVALID_TYPE(
			"problem.dm.dependentEnum.dependentFieldInvalidType"),
		DEPENDENT_ENUM_MASTER_FIELD_INVALID_TYPE("problem.dm.dependentEnum.masterFieldInvalidType"),
		DEPENDENT_ENUM_INVALID_MASTER_ENUMERATION_VALUE(
			"problem.dm.dependentEnum.invalidMasterEnumerationValue"),

		DEPENDENT_ENUM_INVALID_DEPENDENT_ENUMERATION_VALUE(
			"problem.dm.dependentEnum.invalidDependentEnumerationValue"),
		DEPENDENT_ENUM_INVALID_VALUE_FOR_MASTER_CHANGE_ENUMERATION_VALUE(
			"problem.dm.dependentEnum.invalidValueForMasterChangeEnumerationValue"),
		DEPENDENT_TYPE_MASTER_FIELD_INVALID_TYPE("problem.dm.dependentType.masterFieldInvalidType"),
		DM_EXPANSION_EXCEPTION("problem.dm.model.expansionException"),
		HIDE_CONDITION_MASTER_FIELD_INVALID_TYPE("problem.dm.hideCondition.masterFieldInvalidType"),
		HIDE_CONDITION_INVALID_MASTER_VALUE("problem.dm.hideCondition.invalidMasterValue"),
		...
		MODEL_COULD_NOT_BE_RESOLVED("problem.model.failedToResolve");
	...
	public String getLocalizedMessage(final Locale locale, final String keyValue) {
		final ResourceBundle bundle =
			ResourceBundle.getBundle("com.mgmtp.a12.formengine.consistency.i18n.ErrorMessages", locale);
