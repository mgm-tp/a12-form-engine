...
/**
 * Convenience methods for accessing data structures.
 */
public abstract class FormModelUtil {

	private FormModelUtil() {
	}

	public static String getDocumentModelReference(final FormModel model) {
	...
	public static MultilingualTextType getSuffix(final IElement element, final FormModel model) {
