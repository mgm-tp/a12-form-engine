...
public abstract class AbstractRepeatRule implements ConsistencyRule {
	...
	public List<Problem> execute(final FormModel model, final DocumentModelAccess documentModelAccess) throws ConsistencyValidationException {
		...
		final AbstractRepeatChecker ruleChecker = getRuleChecker(model, problems, documentModelAccess);
	...
	public abstract AbstractRepeatChecker getRuleChecker(FormModel model, List<Problem> problems, DocumentModelAccess documentModelAccess);
