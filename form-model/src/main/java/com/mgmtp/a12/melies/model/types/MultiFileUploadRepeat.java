...
public interface MultiFileUploadRepeat {
	...
	public RepeatType withMultiFileUpload(Boolean value);
	
	public RepeatType withMultiFileUploadOptions(MultiFileUploadOptionType value);
}
