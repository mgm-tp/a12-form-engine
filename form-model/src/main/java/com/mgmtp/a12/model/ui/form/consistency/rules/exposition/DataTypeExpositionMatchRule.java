 ...
 */
package com.mgmtp.a12.model.ui.form.consistency.rules.exposition;
...
import com.mgmtp.a12.melies.model.types.FieldBasedInput;
...
public class DataTypeExpositionMatchRule extends AbstractRuleWithDocumentModelService<MeliesModel> {
	...
	public List<Problem> executeRule(final MeliesModel model) throws FatalRuleProblemException {
		...
		final ExpositionConsistencyChecker checker = new ExpositionConsistencyChecker(documentModelService, model);
	...
	private static class ExpositionConsistencyChecker extends ModelVisitor {
		...
		ExpositionConsistencyChecker(final DocumentModelAccess documentModelService, final MeliesModel model) {
