 ...
 */
package com.mgmtp.a12.model.ui.form.consistency.rules.repeat.nesting;

import com.mgmtp.a12.kernel.md.model.api.IGroup;
import com.mgmtp.a12.melies.model.MeliesModel;
import com.mgmtp.a12.melies.model.internal.DocumentModelAccess;
import com.mgmtp.a12.melies.model.types.AncestorUtil;
...
import static com.mgmtp.a12.model.ui.form.consistency.rules.repeat.ParentUtil.isEqualById;
import static com.mgmtp.a12.model.ui.form.consistency.rules.repeat.ParentUtil.isParent;
...
public class RepeatNestingRule extends AbstractRepeatRule {
	...
	public AbstractRepeatChecker getRuleChecker(final MeliesModel model, final List<Problem> problems) {
		return new RepeatNestingChecker(model.getHeaderId(), createDocumentModelService(model, problems));
	}
