...
import com.mgmtp.a12.melies.model.types.MultiFileUploadOptionType;
import com.mgmtp.a12.melies.model.types.MultiFileUploadRepeat;
...
import static com.mgmtp.a12.model.ui.form.consistency.FormModelCategory.FORM_MODEL_REPEAT_MULTI_FILE_UPLOAD_NO_ATTACHMENT_COLLECTION;
import static com.mgmtp.a12.model.ui.form.consistency.FormModelCategory.FORM_MODEL_REPEAT_MULTI_FILE_UPLOAD_NO_ELEMENT_REF;
import static com.mgmtp.a12.model.ui.form.consistency.FormModelCategory.FORM_MODEL_REPEAT_MULTI_FILE_UPLOAD_UNUSED_OPTIONS;
...
public class MultiFileUploadRule extends AbstractRepeatRule {
	...
	public AbstractRepeatChecker getRuleChecker(final MeliesModel model, final List<Problem> problems) {
		return new MultiFileUploadChecker(model.getHeaderId(), problems, createDocumentModelService(model, problems));
	}
