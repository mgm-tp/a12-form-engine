...
import com.mgmtp.a12.melies.model.types.DependentControlsType;
 ...
 */
public class FormDependentControlRule extends AbstractRuleWithDocumentModelService<MeliesModel> {
	...
	public List<Problem> executeRule(final MeliesModel model) {
		...
		final Map<String, ElementContextInfo> screenElementContextInfo =
			screenElementInfoCollector.collectScreenElementContextInfos(model, documentModelService);
