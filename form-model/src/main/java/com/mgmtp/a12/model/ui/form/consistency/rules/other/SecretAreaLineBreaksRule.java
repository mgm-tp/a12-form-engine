 ...
 */
public class SecretAreaLineBreaksRule extends AbstractRuleWithDocumentModelService<MeliesModel> {

	private static Problem problem(
		final MeliesModel model, final FieldBasedInput fieldBasedInput,
