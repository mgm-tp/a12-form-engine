...
import com.mgmtp.a12.melies.model.types.ControlIndexEnumType;
...
public class ControlConsistencyRule extends AbstractRuleWithDocumentModelService<MeliesModel> {
	@Override
	public List<Problem> executeRule(MeliesModel model) {
		final List<Problem> problems = new ArrayList<>();
		final DocumentModelAccess documentModelService = createDocumentModelService(model, problems);
		final ControlConsistencyChecker checker = new ControlConsistencyChecker(documentModelService, model);
	...
	private static class ControlConsistencyChecker extends ModelVisitor {
		...
		ControlConsistencyChecker(final DocumentModelAccess documentModelService, final MeliesModel model) {
