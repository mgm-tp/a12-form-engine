...
import { setupFormEngineRendererWithRtlAsync } from "../setup.js";

export interface RenderWithInputMap extends RtlRenderWrapper {
	readonly inputMap: InputMap;
}

export async function renderWithInputMocks(
