 ...
 * props.modelElement (an Inputs.ModelElement structure) to do the actual
 * asserts.
 */
export function renderStringInput(opts: {
	locale?: Locale;
	models: Models;
	document?: object;
	elementId: string;
	...
	return query(inputMap.StringInput).withProp("uiId", elementId).props().modelElement;
}
