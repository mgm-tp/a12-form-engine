...
/** @internal */
export interface DefaultRowActionResult {
	triggerAction(rowPath: EntityInstancePath, repeatFormModelPath: ModelPath): void;
	getLocalizables(localizationFactory: LocalizableFactory): Localizable[];
	eventName: string;
}
