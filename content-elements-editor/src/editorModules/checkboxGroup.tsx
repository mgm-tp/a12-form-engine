...
import type { CheckboxGroupNode } from "@com.mgmtp.a12.formengine/formengine-content-elements";
...
import CheckboxGroupIcon from "./icons/checkboxGroup.icon.svg";

/** @internal */
export const CheckboxGroupEditorModule: EditorElementModule<CheckboxGroupNode> = extendModule({
	module: FormElementsModules.CheckboxGroup,
	label: "Checkbox Group",
	icon: <img src={CheckboxGroupIcon} alt="Checkbox Group Icon" />,
	settingsRenderer: CheckboxGroupSettingsRenderer,
	editingRenderer: createEditingRenderer(FormElementsModules.CheckboxGroup.renderer)
});

function CheckboxGroupSettingsRenderer(props: NodeSettingProps<CheckboxGroupNode>): JSX.Element {
	return (
		<>
			<SettingTemplate.Section label="General">
				<ElementIdSetting
					nodeId={props.nodeId}
					elementFilter={{ groupUsageTypes: ["multi-select"] }}
				/>
			...
			<SettingTemplate.Section label="Additional Settings">
				...
				<SelectSetting
					...
					width={120}
				/>
				<SwitchSetting label={"Enable Select All"} settingPath={["enableSelectAll"]} />
				<SwitchSetting label={"Inline"} settingPath={["inline"]} />
			</SettingTemplate.Section>
			<AnnotationsSetting />
		</>
	);
