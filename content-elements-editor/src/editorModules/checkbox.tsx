...
import type { CheckboxNode } from "@com.mgmtp.a12.formengine/formengine-content-elements";
...
/** @internal */
export const CheckboxEditorModule: EditorElementModule<CheckboxNode> = extendModule({
	module: FormElementsModules.Checkbox,
	label: "Checkbox",
	icon: <img src={CheckboxIcon} alt="Checkbox Icon" />,
	settingsRenderer: CheckboxSettingsRenderer,
	editingRenderer: createEditingRenderer(FormElementsModules.Checkbox.renderer)
});

function CheckboxSettingsRenderer(props: NodeSettingProps<CheckboxNode>): JSX.Element {
	return (
		<>
