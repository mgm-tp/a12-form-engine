...
import type { SelectNode } from "@com.mgmtp.a12.formengine/formengine-content-elements";
...
/** @internal */
export const SelectEditorModule: EditorElementModule<SelectNode> = extendModule({
	module: FormElementsModules.Select,
	label: "Select",
	icon: <img src={SelectIcon} alt="Select Icon" />,
	settingsRenderer: SelectSettingsRenderer,
	editingRenderer: createEditingRenderer(FormElementsModules.Select.renderer)
});

function SelectSettingsRenderer(props: NodeSettingProps<SelectNode>): JSX.Element {
	return (
		<>
			<SettingTemplate.Section label="General">
				<ElementIdSetting
					nodeId={props.nodeId}
					elementFilter={{ fieldTypes: ["BooleanType", "EnumerationType"] }}
				/>
