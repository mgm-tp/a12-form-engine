...
import { PreviewThemeProvider } from "../provider/previewThemeProvider.js";
import { WidgetThemeProvider } from "../provider/widgetThemeProvider.js";
...
export function PreviewApplication(props: PreviewApplicationProps): JSX.Element {
	...
	return (
		<PreviewThemeProvider activityId={activityId}>
			{Modal && (
				<Modal
			...
			<PreviewApplicationTemplate {...previewProps}>
				<WidgetThemeProvider activityId={activityId}>{props.children}</WidgetThemeProvider>
