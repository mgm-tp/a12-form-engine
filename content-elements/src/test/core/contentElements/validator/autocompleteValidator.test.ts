...
function field(
	fieldType: "EnumerationType" | "StringWithHintList" | "StringType" | "BooleanType"
	...
	return {
		...
		type: "Field",
		fieldType: {
			type: fieldType === "StringWithHintList" ? "StringType" : fieldType,
			values: [],
			hintList: fieldType === "StringWithHintList" ? [] : undefined
		}
	};
}
