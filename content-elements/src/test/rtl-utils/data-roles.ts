...
export const DATE_INPUT = "date-input";
export const DATE_TIME_INPUT = "date-time-input";
export const TIME_INPUT = "time-input";
export const DATE_RANGE_INPUT = "date-range-input";
export const DATE_FRAGMENT_INPUT = "date-fragment-input";
...
export const TEXT_AFFIX = "text-affix";
export const MESSAGE_BOX = "messagebox";
export const ERROR_TOOLTIP = "error-tooltip";
