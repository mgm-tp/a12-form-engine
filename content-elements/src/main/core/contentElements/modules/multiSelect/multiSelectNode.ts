...
/** @internal */
export function isMultiSelectNode(node: ContentModel.Node): node is MultiSelectNode {
	return node.namespace === FORM_ELEMENTS_NAMESPACE && node.type === MULTI_SELECT_TYPE;
}
