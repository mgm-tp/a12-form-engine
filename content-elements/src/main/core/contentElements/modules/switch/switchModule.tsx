...
import { SWITCH_TYPE } from "./switchNode.js";
import { switchValidator } from "./switchValidator.js";

/** @internal */
export const SwitchModule = createElementModule<SwitchNode>({
	type: SWITCH_TYPE,
...
function SwitchRenderer(
	...
	const { Switch } = useContext(WidgetMapContext);
	...
	return (
		<Switch
			...
			checked={value === true}
			label={label}
			uncheckedOption={uncheckedLabel}
			checkedOption={checkedLabel}
			readonly={readonly}
			hideLabel={hideLabel}
