...
/** @internal */
export function isDatePickerNode(node: ContentModel.Node): node is DatePickerNode {
	return node.namespace === FORM_ELEMENTS_NAMESPACE && node.type === DATE_PICKER_TYPE;
}
