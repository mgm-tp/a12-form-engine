...
export namespace FormModel {
	...
	export interface Annotated {
		readonly annotation?: ReadonlyArray<Annotation>;
	}
	...
	export interface Content {
		...
		/**
		 * Same as {@link FormModel.Content.amountSuffix}, but uses the
		 * localized value of the referenced field instead.
		 */
		readonly amountSuffixFieldRef?: string;
		...
		/**
		 * Whether required fields should be marked with an asterisk
		 * or not.
		 * If nothing is given the asterisk will be shown on the label
		 * of required fields.
		 */
	 ...
	 */
	export interface HeaderFooterType extends Stylable {
		/** The unique id. */
		readonly id: string;
		/**
	 ...
	 */
	export interface BasicScreenElement extends IdNamed, Annotated, Stylable {
	 ...
	 */
	export interface CustomScreenElement extends BasicScreenElement, IdNamed {
	...
	export interface RowAction extends Annotated {
		...
		/** The enablement scope of this row action button */
	...
	export interface TableStyle {
		...
		/**
		 * The width of the action column.
		 ...
		 * Only applied if cardView is enabled.
		 */
	 ...
	 */
	export interface RepeatOverviewColumnBase extends Annotated {
	...
	/** Container for cells. */
	export interface Row extends Annotated, Stylable {
		readonly type: "Row";
	 ...
	 */
	export interface Cell extends Annotated {
		readonly id: string;
	...
	export interface ExpressionCell extends Cell {
		 ...
		 * The definition of the expression language can be found in the UI-Designer documentation.
		 */
		readonly expression: string;
	...
	export interface DatePickerConfig {
		...
		/**
		 * The maximum year which should be shown in the year selction.
		 */
	...
	// Supporting Types und Elements
	/**
	 * Annotations for model elements.
	 */
	...
	export interface ButtonStyling extends Stylable {
		...
		/** A probably longer multilingual text, describing the item */
	...
	export interface DependentGroupCase {
		...
		/**
		 * Hides the group if the master field
		...
		/**
		 * Clears the group if the master field
		 * has the defined master value.
		 */
	...
	export interface DependentFieldCase {
		...
		/**
		 * Hides all controls which are referencing
		 * the field.
		 */
		readonly hidden?: boolean;
	...
	export type MarkingOfRequiredFields = "NONE" | "REQUIRED";
