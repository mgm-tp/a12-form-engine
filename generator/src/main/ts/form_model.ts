 ...
 *
 * It was created by copying the runtime model from the core package and
 * removing runtime stuff.
 *
 * TODO: Should the SME already be using this schema for loading/saving/preview?
 */
...
export namespace FormModel {
	...
	export interface HeaderFooterType {
		// TODO: Can we add a type property here as well?
	...
	/**
	 * Data structure to define a case for a hide condition.
	 */
